...
//
//  This file handles event conflict detection for Notchly.
//  - Detects overlapping events within the same day.
//  - Excludes all-day events from conflict detection but still displays them.
//  - Provides a structured UI for displaying conflicts.
//
