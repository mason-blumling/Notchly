...
class NotchlyTestingHelper {
    ...
    @objc func resetIntroExperience() {
        ...
        print("✅ Intro experience reset - restart app to see intro")
    ...
    @objc func resetAppSettings() {
        ...
        print("✅ App settings reset - restart app to reinitialize")
    ...
    private func resetEKEventStorePermissions() {
        /// This won't fully remove the permission from TCC database
        /// but will reset the internal EventKit permission cache
        let eventStore = EKEventStore()
        
        /// Request access to reset internal state
        eventStore.requestFullAccessToEvents { _, _ in
            print("✅ Calendar permissions reset")
        }
    }
